...
RcppExport SEXP _flowCoreUtils_fcs_rcpp_read_data(SEXP file_pathSEXP, SEXP byte_offsetSEXP, SEXP n_rowSEXP, SEXP n_parSEXP, SEXP swapSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_flowCoreUtils_fcs_rcpp_read_data", (DL_FUNC) &_flowCoreUtils_fcs_rcpp_read_data, 5},
    {NULL, NULL, 0}
};

RcppExport void R_init_flowCoreUtils(DllInfo *dll) {
